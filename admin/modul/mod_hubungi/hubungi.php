  ...
  <th>Aksi</th>
   ...
   <tbody>";
    ...
    echo "<tr class=gradeX> 
      ...
      <td width=80>
	 <a href=?module=hubungi&act=balasemail&id=$r[id_hubungi] rel=tooltip-top title='Baca' class='with-tip'>
     <center><img src='img/unread.png'></a>
...
echo "<tr class=gradeX> 
	  ...
	  <td>$tgl</a></td>
     <td width=80>
	 <a href=?module=hubungi&act=balasemail&id=$r[id_hubungi] rel=tooltip-top title='Balas' class='with-tip'>
     <center><img src='img/read.png'></a>
   
     <a href=javascript:confirmdelete('$aksi?module=hubungi&act=hapus&id=$r[id_hubungi]') 
     title='Hapus' class='with-tip' rel=tooltip-top>&nbsp;&nbsp;&nbsp;&nbsp;<img src='img/hapus.png'></center></a> 
